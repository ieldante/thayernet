...
The experiments compare three learned formulations. Thayer-Direct predicts the
clean target from the blended image. Thayer-Residual predicts the contaminant
layer and reconstructs by subtraction. Thayer-BR v0.1 keeps the residual
objective but changes the training distribution toward normal blends,
core-overlap blends, and brightness/size stress blends.
