...
dataset is not included in the repository. Original cutouts are split into
train, validation, and test partitions before synthetic blends are generated,
preventing source-image leakage across training and evaluation.
...
component to the target. This avoids artificial rectangular boundaries and
